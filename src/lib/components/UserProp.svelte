...
{:else if view === "publish"}
	<div class="group flex relative text-surface-800 dark:text-surface-50 overflow-hidden
		 		p-2 rounded-lg text-sm">
		{#if role!=="Publisher"}
			<button type="button" on:click={removeMaintainer} class="absolute top-0 right-0 rounded-full group-hover:block bg-red-500 text-white flex items-center justify-center">
