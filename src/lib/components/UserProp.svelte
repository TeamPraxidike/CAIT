<script lang="ts">
    ...
    link=`/user`;
    //temporary for hoverName to deal with flickering popups, later will be removed
...
<span class="group-hover:block hidden rounded dark:bg-surface-600 dark:text-surface-50 bg-surface-50 text-surface-800 bg-opacity-100 shadow-md" style="z-index:9999" data-popup={hoverName}>
    {name}
</span>
...
{#if view === "search"}
        ...
        <div class="flex flex-col space-y-1 items-start w-full md:pb-2" >
            <div class="w-full flex flex-col items-center">
                ...
                <div class="max-w-full items-center">
                    <div class="dark:text-surface-50 text-surface-900 max-w-full truncate md:text-2xl" use:popup={popupHoverTop}>{name}</div>
    ...
    <a href={link} style="height:fit-content" use:popup={popupHoverBottom}  class="[&>*]:pointer-events-none md:col-span-1 overflow-hidden card dark:bg-surface-700 p-2 card-hover bg-surface-50 hover:cursor-pointer rounded-lg hover:shadow-lg shadow hover:ring-1 hover:ring-primary-600 hover:ring-opacity-20r">
    ...
    <div style="height:fit-content" class="col-span-1 w-[80] group flex relative flex-col text-surface-800 dark:text-surface-50 overflow-hidden card dark:bg-surface-700 p-2 card-hover bg-surface-50 rounded-lg hover:shadow-lg shadow">
...
<!--home-->
    {:else }
    <a href={link} use:popup={popupHoverTop}  class="[&>*]:pointer-events-none flex-none col-span-2 h-20 text-surface-800 dark:text-surface-50 overflow-hidden card dark:bg-surface-700 pl-2 pr-2 card-hover bg-surface-50 hover:cursor-pointer rounded-lg hover:shadow-lg shadow hover:ring-1 hover:ring-primary-600 hover:ring-opacity-20r">
