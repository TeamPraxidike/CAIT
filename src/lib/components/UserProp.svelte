...
{#if view === "search"}
        ...
        <div class="flex flex-col space-y-1 items-start w-full md:pb-2" >
            <div class="w-full flex flex-col items-center">
                ...
                <div class="max-w-full items-center">
                    <p class="dark:text-surface-50 text-surface-800 max-w-full hover:line-clamp-2 hover:relative line-clamp-1 md:text-2xl">{name}</p>
            ...
            <div class="group-hover:flex-row  flex justify-between items-start w-full">
    ...
    <a href={link} style="height:fit-content"  class="col-span-1 overflow-hidden card dark:bg-surface-700 p-2 card-hover bg-surface-50 hover:cursor-pointer rounded-lg hover:shadow-lg shadow hover:ring-1 hover:ring-primary-600 hover:ring-opacity-20r">
        <div class="flex flex-col flex-1 items-center justify-center space-y-1">
            ...
            <div>
                <div class="line-clamp-1 hover:line-clamp-2">{name}</div>
    ...
    <div style="width:fit-content; height:fit-content" class="w-max-full group flex relative flex-col text-surface-800 dark:text-surface-50 overflow-hidden card dark:bg-surface-700 p-2 card-hover bg-surface-50 rounded-lg hover:shadow-lg shadow">
        ...
        <div class="flex flex-col items-center">
            ...
            <div>
                <div class="truncate w-max-full">{name}</div>
                <hr class="bg-surface-300"/>
            </div>
        </div>
    </div>
