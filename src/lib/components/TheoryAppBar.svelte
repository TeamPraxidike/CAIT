...
<div class = "flex items-center justify-center items-center ">
    ...
    <div tabindex="0" role="button" bind:this={divElement} on:mousemove={handleOnMove} on:touchmove={handleOnMoveTouch} on:mousedown={start} on:mouseup={finsih} on:touchstart={start} on:touchend={finsih}>
