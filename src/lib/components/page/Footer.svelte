...
<footer class="w-screen py-20 text-surface-400 mt-28">
    <Grid>
        <!-- Left Section -->
        ...
        <!-- Central Section -->
        <div class="flex flex-col gap-4 col-span-4 mt-16
                    md:row-start-2 md:col-span-3 xl:mt-0
                    xl:row-start-1 xl:col-start-5 xl:col-span-4">
            <h4>Links</h4>
