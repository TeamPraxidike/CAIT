			...
			<div class="w-full md:w-1/2	">
				...
				<div class="flex flex-row ">
					<input type="text" name="copyright" bind:value={dataMaterial.copyright} on:keydown={handleInputEnter}
						...
						<button class="inline-flex items-center shrink-0 p-2 text-white bg-primary-600 hover:bg-primary-500 rounded-xl shadow-md transition duration-200 dark:text-surface-50" on:click={()=> (popupOpen = true)}> Help me pick a license </button>
					{#if popupOpen}
