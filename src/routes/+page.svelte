...
<div id="hero" class="col-span-4 flex gap-y-8 flex-col-reverse row-start-1 items-center
    ...
    <div class="flex flex-col gap-9 z-10
        ...
        <div class="flex flex-col gap-4 ">
            ...
            <h4 class="xl:pr-40 xl:text-1xl dark:text-surface-200">Community for AI Teachers: Contribute and search for lecture materials, assignments, exam questions and more!</h4>
        </div>
